...
| 65.8 | **Benchmark test suite** | `tests/test_merge_performance.py` (new) | Medium | Synthetic benchmarks: generate N workbooks (10, 25, 50, 100) with M tables each, run merge, assert completion in <T seconds. `RUN_BENCHMARKS=1` gate, not run in CI by default. |
